...
import VilaContent from "../components/HomePageContent/VilaContent";
import EjareVila from "../components/EjareVila/EjareVila";
import BoxVila from "../components/EjareVila/BoxVila";
import ServicesVila from "../components/services/ServicesBottom/ServicesVila";
import ServicesbtnsVila from "../components/services/ServicesTop/ServicesBtnsVila";
import ItemSliderReserveVila from "../components/EjareVila/ItemSliderVila";
...
const Vila = () => {
  ...
  const Swiper = (e) => {
    document
      .querySelector(".slider-reserve-vila").addEventListener("mousemove", function () {
        if (e.pageX < oldx) {
          console.log("left");
          document.querySelector(".btn-right-slider").style.display = "flex";
          if (count >= 25) {
