...
import ButtonConfirmAndReject from "../../ButtonConfirmAndReject/ButtonConfirmAndReject";
...
const DesktopAccount = () => {
  ...
  const sheba = useRef(0);
  const hesab = useRef(0);
  const cart = useRef(0);
  const name = useRef(0);
  ...
  const dateDay = useRef(0);
  const dateMonth = useRef(0);
  const dateYear = useRef(0);
        ...
        <div className="contentAccount">
          ...
          <div className="InformationsAccountDesktop">
            <div className="Informations">
              ...
              <div className="Button">
                <HoverButton
                  title={" حساب کاربری علی‌بابا پلاس "}
                  icon={<PlusIcon />}
                />
              </div>
            </div>
              ...
              <div className="EditUserName">
                <button>
                  <svg
                    ...
                    class="ml-1"
                  >
                    <path d="M8.796 10.932a2.136 2.136 0 1 1 0-4.272 2.136 2.136 0 0 1 0 4.272Zm11.986 5.927-1.435-1.436a.742.742 0 0 0-.526-.218h-1.41v-1.41a.743.743 0 0 0-.745-.743h-1.409v-1.41a.745.745 0 0 0-.218-.526l-.733-.733c.293-1.003.31-2.06.042-3.086-.56-2.151-2.4-3.844-4.577-4.211-1.892-.32-3.74.266-5.08 1.604-1.34 1.34-1.925 3.192-1.606 5.081.368 2.177 2.061 4.017 4.211 4.577a5.762 5.762 0 0 0 3.086-.043l6.477 6.477c.14.14.328.218.526.218h2.154c.804 0 1.46-.656 1.46-1.46v-2.155a.744.744 0 0 0-.217-.526Z"></path>
                  </svg>
                  <h6> ویرایش کلمه عبور </h6>
                </button>
              </div>
          ...
          <div className="Personal">
            <div className="PersonalInformation">
              ...
              <div
                ...
                style={
                  open === false ? { display: "block" } : { display: "none" }
                }
              >
                <HoverButton title={"ویرایش اطلاعات"} icon={<Pen />} />
              </div>
              ...
              <div className="container-personal-information">
                <div className="body-information">
                  <div className="card-information">
                    <div className="box-cinformation">
                      <SearchInput label="نام" refLabel={name} />
                    </div>
                    <div className="box-cinformation">
                      <SearchInput label="نام خانوادگی" refLabel={lastname} />
                    </div>
                    <div className="box-cinformation border-left">
                      <SearchInput label="روز" refLabel={dateDay} />
                      <SearchInput label="ماه" refLabel={dateMonth} />
                      <SearchInput label="سال" refLabel={dateYear} />
                    </div>
                  </div>
                  ...
                  <div className="card-information">
                    ...
                    <div className="box-cinformation">
                      <SearchInput label="شماره تماس ضروری" refLabel={phone} />
                      <label htmlFor="">
                        این شماره فقط برای زمان‌های ضروری که شماره اصلی شما در
                        دسترس نباشد مورد استفاده قرار میگیرد.
                      </label>
                    </div>
                  </div>
                </div>
          ...
          <div className="Bank">
            <div className="BankInformation">
              ...
              <div
                ...
                style={
                  opens === false ? { display: "block" } : { display: "none" }
                }
              >
                <HoverButton title={"ویرایش اطلاعات"} icon={<Pen />} />
              </div>
            ...
            {opens === false ? (
              ...
              <div className="container-personal-information">
                <div className="body-information">
                  ...
                  <div className="card-information">
                    <div className="box-cinformation">
                      <SearchInput label="شماره شبا" refLabel={sheba} />
                    </div>
                    <div className="box-cinformation">
                      <SearchInput label="شماره حساب" refLabel={hesab} />
                    </div>
                    <div className="box-cinformation">
                      <SearchInput label="شماره کارت" refLabel={cart} />
                    </div>
                  </div>
                </div>
                <div className="footer-information">
