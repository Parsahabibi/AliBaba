...
const DesktopAccount = () => {
  ...
  // let input;
  // useEffect(() => {
  //    input = document.querySelector(NewSearchInput);
  // }, [])
                  ...
                  <div style={openModal === true ? { display: 'inline' } : { display: 'none' }} className='modalEditMobile'>
                    ...
                    <div className='ItemsModalEditMobile'>
                      ...
                      <div style={{ border: '1px solid #E2E6E9', borderRadius: '8px', width: '80%', margin: '0 auto 20px auto' }}>
                        <NewSearchInput label={'شماره موبایل'} func={{ isable: handleAble, isntAlbe: handleDisAble }} type={'number'} />
                      </div>
                      <button onClick={() => { able === true ? setOpenModal(false) : setOpenModal(true) }} style={{ width: '80%' }} className={able === true ? 'able' : 'disAble'}>تایید و دریافت کد</button>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div style={openModalTwo === true ? { display: 'inline' } : { display: 'none' }} className='modalEditMobile'>
                  ...
                  <div className='ItemsModalEditMobile'>
                    ...
                    <div style={{ border: '1px solid #E2E6E9', borderRadius: '8px', marginBottom: '20px', width: '85%', margin: '0 auto 20px auto' }}>
                      <NewSearchInput label={'آدرس ایمیل'} func={{ isable: handleAble, isntAlbe: handleDisAble }} type={'email'} />

                    </div>
                    <button onClick={() => { able === true ? setOpenModalTwo(false) : setOpenModalTwo(true) }} style={{ width: '80%' }} className={able === true ? 'able' : 'disAble'}>تایید </button>
                  </div>
                </div>
              </div>
              <div className='EditUserName'>
                ...
                <div style={openModalThree === true ? { display: 'inline' } : { display: 'none' }} className='modalEditMobile'>
                  ...
                  <div className='ItemsModalEditMobile'>
                    ...
                    <button onClick={() => { able === true ? setOpenModalThree(false) : setOpenModalThree(true) }} style={{ width: '100%' }} className={able === true ? 'able' : 'disAble'}> تغییر رمز عبور </button>
                  </div>
                </div>
              </div>
            </div>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', paddingBottom: '30px' }}>
                      ...
                      <div className='left'>
                        <div style={{ marginBottom: '2rem', position: 'relative' }}>
                          ...
                          <div style={{ border: '1px solid #E2E6E9', borderRadius: '8px', paddingLeft: '32px' }}>
                            <NewSearchInput label={'تاریخ تولد'} />
                          </div>
                        ...
                        <div style={{ border: '1px solid #E2E6E9', borderRadius: '8px', position: 'relative' }}>
                          <NewSearchInput label={'شماره تماس ضروری'} />
            ...
            </div>
            {
              opens === false ?
                ...
                <div className='InputBank'>
                  ...
                  <div className='input'>
                    <div style={{ border: '1px solid #E2E6E9', borderRadius: '8px', paddingLeft: '32px' }}><NewSearchInput label={'شماره شبا'} /></div>
                    <div style={{ border: '1px solid #E2E6E9', borderRadius: '8px', paddingLeft: '32px' }}><NewSearchInput label={'شماره حساب'} /></div>
                    <div style={{ border: '1px solid #E2E6E9', borderRadius: '8px', paddingLeft: '32px' }}><NewSearchInput label={'شماره کارت'} /></div>
                  </div>
                  <div className='buttons'>
