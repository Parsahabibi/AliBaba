      ...
      <section className='footer-desktop'>
        ...
        <section className='middle-footer-mobile'>
          <section className='top-middle-footer-mobile'>
            ...
            <section className='locations'>
              ...
              <ul>
                <li><Link to=''>بلیط چارتر</Link></li>
                <li><Link to=''>تور کیش</Link></li>
                <li><Link to=''>تور استانبول</Link></li>
                <li><Link to=''>اجاره کلبه جنگلی</Link></li>
                <li><Link to=''>بلیط قطار</Link></li>
                <li><Link to=''>خرید بلیط هواپیما خارجی</Link></li>
                <li><Link to=''>اطلاعات فرودگا‌هی</Link></li>
                <li><Link to=''>شیوه‌نامه حقوق مسافر</Link></li>
                <li><Link to=''>رزرو هتل</Link></li>
                <li><Link to=''>هتل مشهد</Link></li>
                <li><Link to=''>هتل مشهد</Link></li>
                <li><Link to=''>هتل درویشی مشهد</Link></li>
                <li><Link to=''>هتل شایگان کیش</Link></li>
              </ul>
        ...
        <section className='middle-footer-desktop'>
          <section className='top-middle-footer-desktop'>
            ...
            <section className='d-top-middle-footer-desktop d4-top-middle-footer-desktop'>
              ...
              <div className='main-text-footer-dekstop'>
                <div className='tel-poshtibani'>
                  <h6> تلفن پشتیبانی: </h6><h6><a href="tel:02143900000">۰۲۱ - ۴۳۹۰۰۰۰۰ </a></h6>
                </div>
                <h6> دفتر پشتیبانی: اکباتان، نبش اتوبان لشگری، کوی بیمه، خیابان بیمه چهارم، بن‌بست گل‌ها، پلاک 1 </h6>
              </div>
              <div className='namads-alibaba'>
          ...
          <section className='bottom-footer-desktop'>
            <section className='locations'>
              <input type="checkbox" id='checkmore2' />
              <ul>
                <li><Link to=''>بلیط چارتر</Link></li>
                <li><Link to=''>تور کیش</Link></li>
                <li><Link to=''>تور استانبول</Link></li>
        ...
        <section className='bottom-footer-desktop'>
          <div className='d1-bottom-footer-desktop'>
            <div className='copy'>
              <p> کلیه حقوق این سرویس (وب‌سایت و اپلیکیشن‌های موبایل) محفوظ و متعلق به شرکت سفرهای علی‌بابا می‌باشد. </p><span> (نسخه 1.223.0) </span>
            </div>
          </div>
