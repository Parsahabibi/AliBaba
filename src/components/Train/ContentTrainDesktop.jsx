...
const ContentTrainDesktop = () => {
  ...
  return (
    <div className="content-train-desktop">
      <div className="mb-64">
        <h1> بلیط قطار </h1>
        <p>
      ...
      <div className="boxs-majale mb-64">
        <h2>مجله سفر و گردشگری</h2>
        <div className="body-boxs-majale mb-64">
          {BoxMajaleContent.map((item) => (
            <BoxMajale img={item.img} title={item.title} text={item.text} />
          ))}
        </div>
      </div>
    </div>
...
export default ContentTrainDesktop;
